...
class PlaceService {
  static Future<List<PlaceModel>> searchPlace(String keyWord) async {
    String url =
        "${placeBaseUrl}place/textsearch/json?key=AIzaSyAVwW_p2Iz2vv6YIasmFNP7CTd2nrBpFro&language=pt&query=" +
  ...
  static Future<List<PlaceModel>> searchPlaceWithLatAndLong(
    ...
    String url =
        "${placeBaseUrl}geocode/json?latlng=$lat,$long&key=AIzaSyAVwW_p2Iz2vv6YIasmFNP7CTd2nrBpFro";
  ...
  static Future<List<DurationModel>> getDistanceAndDuration(
    ...
    String url =
        "https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins=$from&destinations=$to&key=AIzaSyAVwW_p2Iz2vv6YIasmFNP7CTd2nrBpFro";
  ...
  static Future<dynamic> getStep(
    ...
    String url = "${placeBaseUrl}directions/" +
        ...
        "?origin=" +
        parameters +
        "&key=AIzaSyAVwW_p2Iz2vv6YIasmFNP7CTd2nrBpFro";
